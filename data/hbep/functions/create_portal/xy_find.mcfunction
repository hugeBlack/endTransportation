...
execute if score areaEmpty hbepTemp matches 1 as @e[tag=hbep.yx] at @s align xyz run summon minecraft:falling_block ~0.5 ~ ~0.5 {BlockState:{Name:"minecraft:magenta_stained_glass_pane",Properties:{east:"true",west:"true"}},NoGravity:1b,Time:-947483648,Tags:["hbep.portalHolder","hbep.facingxy","hbep.newPortalHolder"],Passengers:[{id:area_effect_cloud,Age: -947483648, Duration: -1, WaitTime: -947483648,Tags:["hbep.rider"]}]}