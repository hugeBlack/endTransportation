...
execute unless block ~ ~ ~ minecraft:obsidian if score sizeX hbepTemp matches ..8 if score validX hbepTemp matches 1 at @s run function hbep:create_portal/get_size/x_pos