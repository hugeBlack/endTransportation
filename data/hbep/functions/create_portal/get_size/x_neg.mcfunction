...
execute unless block ~ ~ ~ minecraft:black_glazed_terracotta if score sizeX hbepTemp matches ..8 if score validX hbepTemp matches 1 at @s run function hbep:create_portal/get_size/x_neg