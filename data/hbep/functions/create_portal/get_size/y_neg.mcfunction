...
execute unless block ~ ~ ~ minecraft:obsidian if score sizeY hbepTemp matches ..8 if score validY hbepTemp matches 1 at @s run function hbep:create_portal/get_size/y_neg