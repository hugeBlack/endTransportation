...
execute unless block ~ ~ ~ minecraft:black_glazed_terracotta if score sizeZ hbepTemp matches ..8 if score validZ hbepTemp matches 1 at @s run function hbep:create_portal/get_size/z_pos